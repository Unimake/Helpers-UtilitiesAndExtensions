...
namespace Unimake.Helpers_UtilitiesAndExtensions.Test.Net
{
    public class UtilityTest
    {
        ...
        public void Fix_172205(int timeoutInSeconds)
        {
            ...
            watch.Start();
            _ = Utility.HasInternetConnection(timeoutInSeconds);
            watch.Stop();
        ...
        [InlineData(15)]
        [InlineData(30)]
        public void HasInternetConnection(int timeoutInSeconds) => Assert.True(Utility.HasInternetConnection(timeoutInSeconds));
        ...
        public void HasInternetConnectionTest()
        {
            ...
            foreach(string url in testUrls)
            {
                ...
                Assert.True(Utility.HasInternetConnection(null, 3, urls));
            }
            ...
            foreach(string url in testUrls)
            {
                ...
                Assert.False(Utility.HasInternetConnection(null, 3, urls));
            }

            Assert.True(Utility.HasInternetConnection(3));
        }
